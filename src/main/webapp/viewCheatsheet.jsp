...
<div class="container">
    ...
    <div class="header-box">
        ...
        <div class="title-row">
            ...
            <a class="author-link"
               href="${pageContext.request.contextPath}/UserProfileServlet?userId=${sheet.userId}">
                by ${sheet.username}
            </a>
        ...
        <div class="meta-row">
            ...
            <a class="meta-badge"
               href="${pageContext.request.contextPath}/CheatsheetListServlet?categoryId=${sheet.categoryId}">
                📁 ${sheet.categoryname}
            </a>
            ...
            <c:if test="${not empty sessionScope.loginUser}">
                ...
                <c:if test="${sessionScope.loginUser.id ne sheet.userId}">
                    ...
                    <form class="rating-form"
                          action="${pageContext.request.contextPath}/RateCheatsheetServlet"
                          method="post">
                        ...
                        <select name="rating"
                            ...
                            <option value="1"
                                <c:if test="${userRating == 1}">selected</c:if>>
                                ⭐ 1
                            </option>

                            <option value="2"
                                <c:if test="${userRating == 2}">selected</c:if>>
                                ⭐ 2
                            </option>

                            <option value="3"
                                <c:if test="${userRating == 3}">selected</c:if>>
                                ⭐ 3
                            </option>

                            <option value="4"
                                <c:if test="${userRating == 4}">selected</c:if>>
                                ⭐ 4
                            </option>

                            <option value="5"
                                <c:if test="${userRating == 5}">selected</c:if>>
                                ⭐ 5
                            </option>
