...
<title>Public Cheatsheets</title>
                ...
                <c:forEach var="cs"
                    ...
                    <div class="sheet-card">
                        ...
                        <div class="action-row">
                            ...
                            <a class="action-btn private-btn"
                               onclick="return confirm('Make this cheatsheet private?')"
                               href="${pageContext.request.contextPath}/PrivateButtonServlet?id=${cs.id}">
                            ...
                            <a class="action-btn delete-btn"
                               onclick="return confirm('Delete this cheatsheet?')"
